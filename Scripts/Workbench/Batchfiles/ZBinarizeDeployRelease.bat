...
copy "%keyDirectory%\%keyName%.biprivatekey" "%modBuildDirectory%%modName%\Keys\" > nul
							...
							IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\config.cpp" (
								IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\..\config.cpp" (
									IF NOT EXIST "%%~dD%%~pD..\..\..\..\..\..\..\..\config.cpp" (
										...
										echo START /W "BinarizePBO" "%batchDirectory%/BinarizePBORelease.bat" %%D fuckThurston %compression%
										START /W "BinarizePBO" "%batchDirectory%/BinarizePBORelease.bat" %%D fuckThurston %compression%
									)
								)
							)
						)
...
del "%modBuildDirectory%%modName%\Keys\%keyName%.biprivatekey" > nul
goto end
