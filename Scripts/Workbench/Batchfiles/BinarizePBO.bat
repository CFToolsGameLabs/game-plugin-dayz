...
If "%pboName%"=="Scripts" (
	...
	START /w %pboProject% %pboProject% +K +W -F +Stop -P -E=dayz +R "%workDrive%!prefixName!" "+Mod=%modBuildDirectory%%modName%" "+Key=F:\@DayZ\@Keys\cftoolsRoot.biprivatekey"
)
