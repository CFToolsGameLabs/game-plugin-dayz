...
echo Running LaunchLocalMP.bat
...
echo start %clientEXE% %clientLaunchParams% "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true"

start %clientEXE% %clientLaunchParams% "%playerName%" -dologs -adminlog -freezecheck "-scriptDebug=true" -connect=127.0.0.1:2302
